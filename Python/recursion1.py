...
#3. The fibonacci sequence is a famous bit of mathematics, and it happens 
...
#4. We have bunnies standing in a line, numbered 1, 2, ...
...
#5. We have triangle made of blocks. The topmost row has 1 block, the 
...
#6. Given a non-negative int n, return the sum of its digits recursively 
...
#7. Given a non-negative int n, return the count of the occurrences of 7 
...
#8. Given a non-negative int n, compute recursively (no loops) the count 
