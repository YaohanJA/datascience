...
#2 Given a string, compute recursively (no loops) the number of times 
...
#3 Given a string, compute recursively (no loops) a new string where all 
...
#5 Given a string, compute recursively a new string where all the 'x' 
...
#6 Given a string, compute recursively a new string where all the adjacent 
...
def allStar(str):
  if (len(str)<2):
    ...
    return allStar(str[1:])



#7 Given a string, compute recursively a new string where identical chars 
...
#8 Given a string, compute recursively a new string where all the lowercase 
...
#9 We'll say that a "pair" in a string is two instances of a char separated 
...
#10 Count recursively the total number of "abc" and "aba" substrings that 
...
#11 Given a string, compute recursively (no loops) the number of "11" 
...
# 12Given a string, return recursively a "cleaned" string where adjacent 
...
#13 Given a string, compute recursively the number of times lowercase "hi" 
# appears in the string, however do not count "hi" that have an 'x' 
# immedately before them.
def countHi2(str):
  if (len(str)<2):
    return 0
  elif str[0:3] =="xhi" and len(str)>2:
...
#14 Given a string that contains a single pair of parenthesis, compute 
...
#15 Given a string, return True if it is a nesting of zero or more pairs 
...
# 16 Given a string and a non-empty substring sub, compute recursively the 
...
#17 Given a string and a non-empty substring sub, compute recursively if 
...
#18 Given a string and a non-empty substring sub, compute recursively the 
